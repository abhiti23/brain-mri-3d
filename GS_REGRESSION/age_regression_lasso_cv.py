...
def main():
    ...
    parser.add_argument('--out-dir', default='LASSOCV_RESULTS')
    ...
    results_path = os.path.join(args.out_dir, 'age_prediction_results.csv')
    ...
    plt.tight_layout()
    scatter_path = os.path.join(args.out_dir, 'age_prediction_scatter.png')
