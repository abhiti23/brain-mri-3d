...
#SBATCH --cpus-per-task=16         # 16 parallel workers per task
#SBATCH --mem-per-cpu=8gb          # 8gb × 16 CPUs = 128gb per task
#SBATCH --time=02:00:00            # 16 parallel workers should finish 100 subjects in ~2 hrs
...
python get_gaussian_params_v2.py --start $START --end $END --workers $SLURM_CPUS_PER_TASK
